...
%% Commands section
\newcommand{\logentry}[4]{\\[-0.25ex] \selectlanguage{USenglish} \formatdate{#2}{#1}{#3}  & {\noindent{#4}}
\\[1.5ex] \hline}
...
\end{split}\end{equation*}
			...
			\par\textbf{\color{red} Question for Kamangar:} Is there a way given $x$ and $y$ to solve for $u$ and $v$?
		}
		\logentry{5}{22}{2016}{
