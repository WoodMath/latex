...
\subitem Section 2.1: Planar Geometry
\subitem Section 2.2: The 2D projective plane
\subitem Section 2.3: Projective transformations
\subitem Section 2.4: A hierarchy of transformations
\item \textbf{Chapter 6: Camera Models}:
\subitem Section 6.1: Finite cameras
\subitem Section 6.2: The projective camera
\item \textbf{Chapter 9: Epipolar Geometry and the Fundamental Matrix}:
\subitem Section 9.1: Epipolar geometry
\subitem Section 9.2: The fundamental matrix \texttt{F}
\item \textbf{Chapter 11: Computation of the Fundamental Matrix}:
\subitem Section 11.1: Basic Equations
\end{itemize}
