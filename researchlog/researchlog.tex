...
Added some additional text regarding the \textit{epipolar constraint} to the thesis document.
		...
		\logentry{6}{17}{2015}{%
Finished implmenting and testing \texttt{fnDistance.m} for distance matrix. Next will be working on \texttt{fnSimilarity.m} implementing a \textit{Similarity Matrix} for spectral clustering.
		}
%	\hline
	\end{longtable}
